...
model.load_weights('ResNet50_weights3.hdf5')
...
checkpointer = ModelCheckpoint(filepath= './ResNet50_weights4.hdf5', verbose=1, monitor='val_categorical_accuracy',save_best_only=True)
